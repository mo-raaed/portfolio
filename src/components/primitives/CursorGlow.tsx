...
/**
 * A soft radial glow that trails the cursor with a little spring lag. It lives
 * beneath the page's opaque section and card backgrounds (-z-10 above the body
 * canvas), so it reads as ambient light bleeding out from behind the content.
 * Desktop-only (hover + fine pointer); absent under reduced motion. Cursor
 * position drives motion values directly, so it never re-renders on move.
 */
